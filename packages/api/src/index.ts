...
const ALLOWED_ORIGINS = (process.env.CORS_ORIGINS || 'http://localhost:3000,http://localhost:5173,https://fusionpulse.colefusion.com,https://app.fusionpulse.colefusion.com,https://api.fusionpulse.colefusion.com').split(',');
